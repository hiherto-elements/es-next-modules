...
export function Quantize() {
    ...
    this.init_xrpow = (gfc, cod_info, xrpow) => {
        let sum = 0;
    ...
    function psfb21_analogsilence(gfc, cod_info) {
        ...
        if (cod_info.block_type != Encoder.SHORT_TYPE) {
            ...
            for (var gsfb = Encoder.PSFB21 - 1; gsfb >= 0 && !stop; gsfb--) {
                ...
                let ath21 = qupvt.athAdjust(ath.adjust, ath.psfb21[gsfb],
                    ath.floor);
            ...
            for (let block = 0; block < 3; block++) {
                ...
                for (var gsfb = Encoder.PSFB12 - 1; gsfb >= 0 && !stop; gsfb--) {
                    ...
                    let ath12 = qupvt.athAdjust(ath.adjust, ath.psfb12[gsfb],
                        ath.floor);
    ...
    this.trancate_smallspectrums = (gfc, gi, l3_xmin, work) => {
     ...
     */
    this.outer_loop = (gfp, cod_info, l3_xmin, xrpow, ch, targ_bits) => {
        const gfc = gfp.internal_flags;
     ...
     */
    this.iteration_finish_one = (gfc, gr, ch) => {
     ...
     */
    this.VBR_encode_granule = (gfp, cod_info, l3_xmin, xrpow, ch, min_bits, max_bits) => {
        const gfc = gfp.internal_flags;
    ...
    this.VBR_old_prepare = (
        ...
        for (var gr = 0; gr < gfc.mode_gr; gr++) {
            ...
            for (var ch = 0; ch < gfc.channels_out; ++ch) {
                ...
                gfc.masking_lower = 10.0 ** (masking_lower_db * 0.1);
    ...
    this.bitpressure_strategy = (gfc, l3_xmin, min_bits, max_bits) => {
    ...
    this.VBR_new_prepare = (gfp, pe, ratio, l3_xmin, frameBits, max_bits) => {
        const gfc = gfp.internal_flags;
        ...
        for (var gr = 0; gr < gfc.mode_gr; gr++) {
            ...
            for (var ch = 0; ch < gfc.channels_out; ++ch) {
                ...
                gfc.masking_lower = 10.0 ** (gfc.PSY.mask_adjust * 0.1);
     ...
     * mt 2000/05/31
     */
    this.calc_target_bits = (gfp, pe, ms_ener_ratio, targ_bits, analog_silence_bits, max_frame_bits) => {
        const gfc = gfp.internal_flags;
        const l3_side = gfc.l3_side;
        let res_factor;
        let gr;
