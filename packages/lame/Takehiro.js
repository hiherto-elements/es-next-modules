...
export function Takehiro() {
     ...
     * count_bit
     */
    this.noquant_count_bits = (gfc, gi, prev_noise) => {
        const ix = gi.l3_enc;
     ...
     */
    this.scale_bitcount_lsf = (gfc, cod_info) => {
        let table_number;
        let row_in_table;
        let partition;
        let nr_sfb;
